(function(html) {
    ...
    * ------------------------------------------------------ */
    const ssCountdown = function () {
        // Estableciendo finalDate para las 14:00:00 del día actual
        const today = new Date();
        const finalDate = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 14, 0, 0).getTime();
        ...
        function timer() {
            ...
            if (diff <= 0) {
                ...
                // Una vez alcanzado o pasado el tiempo final, podríamos manejar de manera especial, por ejemplo, resetear o mostrar ceros
